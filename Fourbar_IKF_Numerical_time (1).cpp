// ============================================================================
// Fourbar_IKF_Numerical.cpp
// Numerical h_x (Section 3.5.3)
// Compile:
//   g++ -std=c++11 -O3 Fourbar_IKF_Numerical.cpp -o fourbar_server
// Run:
//   ./fourbar_server
// ============================================================================
...
struct LogData {
    ...
    std::vector<double> P_zi, P_zdoti, P_zddoti;
};
